...
QT.global_private.enabled_features = sse2 alloca_malloc_h alloca avx2 dbus gui network sql system-zlib testlib widgets xml
QT.global_private.disabled_features = alloca_h android-style-assets private_tests dbus-linked gc_binaries libudev posix_fallocate reduce_exports reduce_relocations release_tools stack-protector-strong
