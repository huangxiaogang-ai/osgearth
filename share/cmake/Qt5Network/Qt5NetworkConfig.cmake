...
macro(_populate_Network_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Network_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Network_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Network)
    ...
    if (EXISTS
        "${_qt5Network_install_prefix}/debug/bin/Qt5Networkd.dll"
      AND EXISTS
        "${_qt5Network_install_prefix}/debug/lib/Qt5Networkd.lib" )
        _populate_Network_target_properties(DEBUG "Qt5Networkd.dll" "Qt5Networkd.lib" )
    endif()
