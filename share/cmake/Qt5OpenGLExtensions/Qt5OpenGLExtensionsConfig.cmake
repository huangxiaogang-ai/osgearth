...
macro(_populate_OpenGLExtensions_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5OpenGLExtensions_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::OpenGLExtensions)
    ...
    if (EXISTS "${_qt5OpenGLExtensions_install_prefix}/debug/lib/Qt5OpenGLExtensionsd.lib" )
        _populate_OpenGLExtensions_target_properties(DEBUG "Qt5OpenGLExtensionsd.lib" "" )
    endif()
