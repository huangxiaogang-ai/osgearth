...
set(Qt5AxContainer_VERSION_STRING 5.12.5)
...
macro(_populate_AxContainer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5AxContainer_install_prefix}/debug/lib/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5AxContainer_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::AxContainer)
    ...
    foreach(_module_dep ${_Qt5AxContainer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.5 ${_Qt5AxContainer_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt5AxContainer_install_prefix}/debug/lib/Qt5AxContainerd.lib" )
        _populate_AxContainer_target_properties(DEBUG "Qt5AxContainerd.lib" "" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5AxContainer_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_AxContainer_check_file_exists(${imported_location})
