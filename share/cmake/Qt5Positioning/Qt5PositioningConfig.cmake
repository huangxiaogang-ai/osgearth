...
macro(_populate_Positioning_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Positioning_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Positioning_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Positioning)
    ...
    set(Qt5Positioning_PRIVATE_INCLUDE_DIRS
        "${_qt5Positioning_install_prefix}/include/QtPositioning/5.12.5"
        "${_qt5Positioning_install_prefix}/include/QtPositioning/5.12.5/QtPositioning"
    )
    ...
    if (EXISTS
        "${_qt5Positioning_install_prefix}/debug/bin/Qt5Positioningd.dll"
      AND EXISTS
        "${_qt5Positioning_install_prefix}/debug/lib/Qt5Positioningd.lib" )
        _populate_Positioning_target_properties(DEBUG "Qt5Positioningd.dll" "Qt5Positioningd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5Positioning_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_Positioning_check_file_exists(${imported_location})
