...
macro(_populate_3DQuickInput_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt53DQuickInput_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt53DQuickInput_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::3DQuickInput)
    ...
    if (EXISTS
        "${_qt53DQuickInput_install_prefix}/debug/bin/Qt53DQuickInputd.dll"
      AND EXISTS
        "${_qt53DQuickInput_install_prefix}/debug/lib/Qt53DQuickInputd.lib" )
        _populate_3DQuickInput_target_properties(DEBUG "Qt53DQuickInputd.dll" "Qt53DQuickInputd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt53DQuickInput_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_3DQuickInput_check_file_exists(${imported_location})
