...
macro(_populate_DBus_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5DBus_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5DBus_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::DBus)
    ...
    if (EXISTS
        "${_qt5DBus_install_prefix}/debug/bin/Qt5DBusd.dll"
      AND EXISTS
        "${_qt5DBus_install_prefix}/debug/lib/Qt5DBusd.lib" )
        _populate_DBus_target_properties(DEBUG "Qt5DBusd.dll" "Qt5DBusd.lib" )
    endif()
