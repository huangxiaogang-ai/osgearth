...
if (NOT TARGET Qt5::lrelease)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/tools/qt5-tools/bin/lrelease.exe")
...
if (NOT TARGET Qt5::lupdate)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/tools/qt5-tools/bin/lupdate.exe")
    _qt5_LinguistTools_check_file_exists(${imported_location})
...
if (NOT TARGET Qt5::lconvert)
    ...
    set(imported_location "${_qt5_linguisttools_install_prefix}/tools/qt5-tools/bin/lconvert.exe")
    _qt5_LinguistTools_check_file_exists(${imported_location})
