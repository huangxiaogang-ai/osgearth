...
set(Qt5Mqtt_VERSION_STRING 5.12.5)
...
macro(_populate_Mqtt_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Mqtt_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Mqtt_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Mqtt)
    ...
    set(Qt5Mqtt_PRIVATE_INCLUDE_DIRS
        "${_qt5Mqtt_install_prefix}/include/QtMqtt/5.12.5"
        "${_qt5Mqtt_install_prefix}/include/QtMqtt/5.12.5/QtMqtt"
    )
    ...
    foreach(_module_dep ${_Qt5Mqtt_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.5 ${_Qt5Mqtt_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt5Mqtt_install_prefix}/debug/bin/Qt5Mqttd.dll"
      AND EXISTS
        "${_qt5Mqtt_install_prefix}/debug/lib/Qt5Mqttd.lib" )
        _populate_Mqtt_target_properties(DEBUG "Qt5Mqttd.dll" "Qt5Mqttd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5Mqtt_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_Mqtt_check_file_exists(${imported_location})
