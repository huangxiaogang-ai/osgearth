...
macro(_populate_3DCore_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt53DCore_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt53DCore_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::3DCore)
    ...
    if (EXISTS
        "${_qt53DCore_install_prefix}/debug/bin/Qt53DCored.dll"
      AND EXISTS
        "${_qt53DCore_install_prefix}/debug/lib/Qt53DCored.lib" )
        _populate_3DCore_target_properties(DEBUG "Qt53DCored.dll" "Qt53DCored.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt53DCore_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_3DCore_check_file_exists(${imported_location})
