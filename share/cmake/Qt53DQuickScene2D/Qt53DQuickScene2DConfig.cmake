...
macro(_populate_3DQuickScene2D_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt53DQuickScene2D_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt53DQuickScene2D_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::3DQuickScene2D)
    ...
    if (EXISTS
        "${_qt53DQuickScene2D_install_prefix}/debug/bin/Qt53DQuickScene2Dd.dll"
      AND EXISTS
        "${_qt53DQuickScene2D_install_prefix}/debug/lib/Qt53DQuickScene2Dd.lib" )
        _populate_3DQuickScene2D_target_properties(DEBUG "Qt53DQuickScene2Dd.dll" "Qt53DQuickScene2Dd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt53DQuickScene2D_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_3DQuickScene2D_check_file_exists(${imported_location})
