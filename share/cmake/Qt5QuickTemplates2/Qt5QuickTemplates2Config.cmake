...
macro(_populate_QuickTemplates2_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5QuickTemplates2_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5QuickTemplates2_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    set(Qt5QuickTemplates2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTemplates2_install_prefix}/include/QtQuickTemplates2/5.12.5"
        "${_qt5QuickTemplates2_install_prefix}/include/QtQuickTemplates2/5.12.5/QtQuickTemplates2"
    )
    ...
    _populate_QuickTemplates2_target_properties(RELEASE "Qt5QuickTemplates2.dll" "Qt5QuickTemplates2.lib" )
    _populate_QuickTemplates2_target_properties(DEBUG "Qt5QuickTemplates2d.dll" "Qt5QuickTemplates2d.lib" )

    if (EXISTS
        "${_qt5QuickTemplates2_install_prefix}/debug/bin/Qt5QuickTemplates2d.dll"
      AND EXISTS
        "${_qt5QuickTemplates2_install_prefix}/debug/lib/Qt5QuickTemplates2d.lib" )
        _populate_QuickTemplates2_target_properties(DEBUG "Qt5QuickTemplates2d.dll" "Qt5QuickTemplates2d.lib" )
    endif()
