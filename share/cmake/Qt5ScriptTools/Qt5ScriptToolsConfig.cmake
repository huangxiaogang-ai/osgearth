...
macro(_populate_ScriptTools_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5ScriptTools_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5ScriptTools_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::ScriptTools)
    ...
    set(Qt5ScriptTools_PRIVATE_INCLUDE_DIRS
        "${_qt5ScriptTools_install_prefix}/include/QtScriptTools/5.12.5"
        "${_qt5ScriptTools_install_prefix}/include/QtScriptTools/5.12.5/QtScriptTools"
    )
    ...
    if (EXISTS
        "${_qt5ScriptTools_install_prefix}/debug/bin/Qt5ScriptToolsd.dll"
      AND EXISTS
        "${_qt5ScriptTools_install_prefix}/debug/lib/Qt5ScriptToolsd.lib" )
        _populate_ScriptTools_target_properties(DEBUG "Qt5ScriptToolsd.dll" "Qt5ScriptToolsd.lib" )
    endif()
