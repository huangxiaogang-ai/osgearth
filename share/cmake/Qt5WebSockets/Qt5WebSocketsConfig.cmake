...
macro(_populate_WebSockets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5WebSockets_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5WebSockets_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::WebSockets)
    ...
    set(Qt5WebSockets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebSockets_install_prefix}/include/QtWebSockets/5.12.5"
        "${_qt5WebSockets_install_prefix}/include/QtWebSockets/5.12.5/QtWebSockets"
    )
    ...
    if (EXISTS
        "${_qt5WebSockets_install_prefix}/debug/bin/Qt5WebSocketsd.dll"
      AND EXISTS
        "${_qt5WebSockets_install_prefix}/debug/lib/Qt5WebSocketsd.lib" )
        _populate_WebSockets_target_properties(DEBUG "Qt5WebSocketsd.dll" "Qt5WebSocketsd.lib" )
    endif()
