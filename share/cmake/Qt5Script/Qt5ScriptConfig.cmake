...
macro(_populate_Script_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Script_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Script_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Script)
    ...
    set(Qt5Script_PRIVATE_INCLUDE_DIRS
        "${_qt5Script_install_prefix}/include/QtScript/5.12.5"
        "${_qt5Script_install_prefix}/include/QtScript/5.12.5/QtScript"
    )
    ...
    if (EXISTS
        "${_qt5Script_install_prefix}/debug/bin/Qt5Scriptd.dll"
      AND EXISTS
        "${_qt5Script_install_prefix}/debug/lib/Qt5Scriptd.lib" )
        _populate_Script_target_properties(DEBUG "Qt5Scriptd.dll" "Qt5Scriptd.lib" )
    endif()
