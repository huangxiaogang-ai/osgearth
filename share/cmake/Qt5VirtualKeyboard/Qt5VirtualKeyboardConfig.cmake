...
macro(_populate_VirtualKeyboard_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5VirtualKeyboard_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5VirtualKeyboard_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    set(Qt5VirtualKeyboard_PRIVATE_INCLUDE_DIRS
        "${_qt5VirtualKeyboard_install_prefix}/include/QtVirtualKeyboard/5.12.5"
        "${_qt5VirtualKeyboard_install_prefix}/include/QtVirtualKeyboard/5.12.5/QtVirtualKeyboard"
    )
    ...
    _populate_VirtualKeyboard_target_properties(RELEASE "Qt5VirtualKeyboard.dll" "Qt5VirtualKeyboard.lib" )
    _populate_VirtualKeyboard_target_properties(DEBUG "Qt5VirtualKeyboardd.dll" "Qt5VirtualKeyboardd.lib" )

    if (EXISTS
        "${_qt5VirtualKeyboard_install_prefix}/debug/bin/Qt5VirtualKeyboardd.dll"
      AND EXISTS
        "${_qt5VirtualKeyboard_install_prefix}/debug/lib/Qt5VirtualKeyboardd.lib" )
        _populate_VirtualKeyboard_target_properties(DEBUG "Qt5VirtualKeyboardd.dll" "Qt5VirtualKeyboardd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5VirtualKeyboard_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_VirtualKeyboard_check_file_exists(${imported_location})
