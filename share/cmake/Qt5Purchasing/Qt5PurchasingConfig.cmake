...
macro(_populate_Purchasing_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Purchasing_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Purchasing_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Purchasing)
    ...
    set(Qt5Purchasing_PRIVATE_INCLUDE_DIRS
        "${_qt5Purchasing_install_prefix}/include/QtPurchasing/5.12.5"
        "${_qt5Purchasing_install_prefix}/include/QtPurchasing/5.12.5/QtPurchasing"
    )
    ...
    if (EXISTS
        "${_qt5Purchasing_install_prefix}/debug/bin/Qt5Purchasingd.dll"
      AND EXISTS
        "${_qt5Purchasing_install_prefix}/debug/lib/Qt5Purchasingd.lib" )
        _populate_Purchasing_target_properties(DEBUG "Qt5Purchasingd.dll" "Qt5Purchasingd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5Purchasing_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_Purchasing_check_file_exists(${imported_location})
