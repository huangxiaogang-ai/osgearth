...
macro(_populate_Gamepad_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Gamepad_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Gamepad_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Gamepad)
    ...
    if (EXISTS
        "${_qt5Gamepad_install_prefix}/debug/bin/Qt5Gamepadd.dll"
      AND EXISTS
        "${_qt5Gamepad_install_prefix}/debug/lib/Qt5Gamepadd.lib" )
        _populate_Gamepad_target_properties(DEBUG "Qt5Gamepadd.dll" "Qt5Gamepadd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5Gamepad_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_Gamepad_check_file_exists(${imported_location})
