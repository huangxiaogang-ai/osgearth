...
macro(_populate_Gui_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Gui_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Gui_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Gui)
    ...
    if (EXISTS
        "${_qt5Gui_install_prefix}/debug/bin/Qt5Guid.dll"
      AND EXISTS
        "${_qt5Gui_install_prefix}/debug/lib/Qt5Guid.lib" )
        _populate_Gui_target_properties(DEBUG "Qt5Guid.dll" "Qt5Guid.lib" )
    endif()
