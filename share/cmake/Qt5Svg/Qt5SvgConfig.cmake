...
macro(_populate_Svg_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Svg_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Svg_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Svg)
    ...
    set(Qt5Svg_PRIVATE_INCLUDE_DIRS
        "${_qt5Svg_install_prefix}/include/QtSvg/5.12.5"
        "${_qt5Svg_install_prefix}/include/QtSvg/5.12.5/QtSvg"
    )
    ...
    if (EXISTS
        "${_qt5Svg_install_prefix}/debug/bin/Qt5Svgd.dll"
      AND EXISTS
        "${_qt5Svg_install_prefix}/debug/lib/Qt5Svgd.lib" )
        _populate_Svg_target_properties(DEBUG "Qt5Svgd.dll" "Qt5Svgd.lib" )
    endif()
