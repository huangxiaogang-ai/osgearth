...
macro(_populate_Help_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Help_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Help_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Help)
    ...
    set(Qt5Help_PRIVATE_INCLUDE_DIRS
        "${_qt5Help_install_prefix}/include/QtHelp/5.12.5"
        "${_qt5Help_install_prefix}/include/QtHelp/5.12.5/QtHelp"
    )
    ...
    if (EXISTS
        "${_qt5Help_install_prefix}/debug/bin/Qt5Helpd.dll"
      AND EXISTS
        "${_qt5Help_install_prefix}/debug/lib/Qt5Helpd.lib" )
        _populate_Help_target_properties(DEBUG "Qt5Helpd.dll" "Qt5Helpd.lib" )
    endif()
