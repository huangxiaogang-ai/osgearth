...
macro(_populate_3DRender_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt53DRender_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt53DRender_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::3DRender)
    ...
    if (EXISTS
        "${_qt53DRender_install_prefix}/debug/bin/Qt53DRenderd.dll"
      AND EXISTS
        "${_qt53DRender_install_prefix}/debug/lib/Qt53DRenderd.lib" )
        _populate_3DRender_target_properties(DEBUG "Qt53DRenderd.dll" "Qt53DRenderd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt53DRender_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_3DRender_check_file_exists(${imported_location})
