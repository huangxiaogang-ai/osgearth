...
macro(_populate_Scxml_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Scxml_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Scxml_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Scxml)
    ...
    set(Qt5Scxml_PRIVATE_INCLUDE_DIRS
        "${_qt5Scxml_install_prefix}/include/QtScxml/5.12.5"
        "${_qt5Scxml_install_prefix}/include/QtScxml/5.12.5/QtScxml"
    )
    ...
    if (EXISTS
        "${_qt5Scxml_install_prefix}/debug/bin/Qt5Scxmld.dll"
      AND EXISTS
        "${_qt5Scxml_install_prefix}/debug/lib/Qt5Scxmld.lib" )
        _populate_Scxml_target_properties(DEBUG "Qt5Scxmld.dll" "Qt5Scxmld.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5Scxml_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_Scxml_check_file_exists(${imported_location})
