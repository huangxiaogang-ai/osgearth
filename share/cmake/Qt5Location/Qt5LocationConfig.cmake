...
macro(_populate_Location_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Location_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Location_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Location)
    ...
    set(Qt5Location_PRIVATE_INCLUDE_DIRS
        "${_qt5Location_install_prefix}/include/QtLocation/5.12.5"
        "${_qt5Location_install_prefix}/include/QtLocation/5.12.5/QtLocation"
    )
    ...
    if (EXISTS
        "${_qt5Location_install_prefix}/debug/bin/Qt5Locationd.dll"
      AND EXISTS
        "${_qt5Location_install_prefix}/debug/lib/Qt5Locationd.lib" )
        _populate_Location_target_properties(DEBUG "Qt5Locationd.dll" "Qt5Locationd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5Location_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_Location_check_file_exists(${imported_location})
