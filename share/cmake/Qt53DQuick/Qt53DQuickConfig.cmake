...
macro(_populate_3DQuick_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt53DQuick_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt53DQuick_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::3DQuick)
    ...
    if (EXISTS
        "${_qt53DQuick_install_prefix}/debug/bin/Qt53DQuickd.dll"
      AND EXISTS
        "${_qt53DQuick_install_prefix}/debug/lib/Qt53DQuickd.lib" )
        _populate_3DQuick_target_properties(DEBUG "Qt53DQuickd.dll" "Qt53DQuickd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt53DQuick_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_3DQuick_check_file_exists(${imported_location})
