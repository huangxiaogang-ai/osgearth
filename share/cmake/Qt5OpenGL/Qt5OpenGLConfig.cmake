...
macro(_populate_OpenGL_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5OpenGL_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5OpenGL_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/include/QtOpenGL/5.12.5"
        "${_qt5OpenGL_install_prefix}/include/QtOpenGL/5.12.5/QtOpenGL"
    )
    ...
    if (EXISTS
        "${_qt5OpenGL_install_prefix}/debug/bin/Qt5OpenGLd.dll"
      AND EXISTS
        "${_qt5OpenGL_install_prefix}/debug/lib/Qt5OpenGLd.lib" )
        _populate_OpenGL_target_properties(DEBUG "Qt5OpenGLd.dll" "Qt5OpenGLd.lib" )
    endif()
