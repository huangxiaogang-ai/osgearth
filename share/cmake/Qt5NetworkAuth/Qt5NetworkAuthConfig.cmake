...
macro(_populate_NetworkAuth_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5NetworkAuth_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5NetworkAuth_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    set(Qt5NetworkAuth_PRIVATE_INCLUDE_DIRS
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.12.5"
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.12.5/QtNetworkAuth"
    )
    ...
    if (EXISTS
        "${_qt5NetworkAuth_install_prefix}/debug/bin/Qt5NetworkAuthd.dll"
      AND EXISTS
        "${_qt5NetworkAuth_install_prefix}/debug/lib/Qt5NetworkAuthd.lib" )
        _populate_NetworkAuth_target_properties(DEBUG "Qt5NetworkAuthd.dll" "Qt5NetworkAuthd.lib" )
    endif()
