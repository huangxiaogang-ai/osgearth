...
macro(_populate_TextToSpeech_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5TextToSpeech_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5TextToSpeech_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::TextToSpeech)
    ...
    set(Qt5TextToSpeech_PRIVATE_INCLUDE_DIRS
        "${_qt5TextToSpeech_install_prefix}/include/QtTextToSpeech/5.12.5"
        "${_qt5TextToSpeech_install_prefix}/include/QtTextToSpeech/5.12.5/QtTextToSpeech"
    )
    ...
    if (EXISTS
        "${_qt5TextToSpeech_install_prefix}/debug/bin/Qt5TextToSpeechd.dll"
      AND EXISTS
        "${_qt5TextToSpeech_install_prefix}/debug/lib/Qt5TextToSpeechd.lib" )
        _populate_TextToSpeech_target_properties(DEBUG "Qt5TextToSpeechd.dll" "Qt5TextToSpeechd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5TextToSpeech_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_TextToSpeech_check_file_exists(${imported_location})
