...
macro(_populate_XmlPatterns_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5XmlPatterns_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5XmlPatterns_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::XmlPatterns)
    ...
    set(Qt5XmlPatterns_PRIVATE_INCLUDE_DIRS
        "${_qt5XmlPatterns_install_prefix}/include/QtXmlPatterns/5.12.5"
        "${_qt5XmlPatterns_install_prefix}/include/QtXmlPatterns/5.12.5/QtXmlPatterns"
    )
    ...
    if (EXISTS
        "${_qt5XmlPatterns_install_prefix}/debug/bin/Qt5XmlPatternsd.dll"
      AND EXISTS
        "${_qt5XmlPatterns_install_prefix}/debug/lib/Qt5XmlPatternsd.lib" )
        _populate_XmlPatterns_target_properties(DEBUG "Qt5XmlPatternsd.dll" "Qt5XmlPatternsd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5XmlPatterns_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_XmlPatterns_check_file_exists(${imported_location})
