...
macro(_populate_3DQuickExtras_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt53DQuickExtras_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt53DQuickExtras_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::3DQuickExtras)
    ...
    if (EXISTS
        "${_qt53DQuickExtras_install_prefix}/debug/bin/Qt53DQuickExtrasd.dll"
      AND EXISTS
        "${_qt53DQuickExtras_install_prefix}/debug/lib/Qt53DQuickExtrasd.lib" )
        _populate_3DQuickExtras_target_properties(DEBUG "Qt53DQuickExtrasd.dll" "Qt53DQuickExtrasd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt53DQuickExtras_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_3DQuickExtras_check_file_exists(${imported_location})
