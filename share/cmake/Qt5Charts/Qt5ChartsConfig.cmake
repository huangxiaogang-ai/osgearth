...
macro(_populate_Charts_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Charts_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Charts_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Charts)
    ...
    if (EXISTS
        "${_qt5Charts_install_prefix}/debug/bin/Qt5Chartsd.dll"
      AND EXISTS
        "${_qt5Charts_install_prefix}/debug/lib/Qt5Chartsd.lib" )
        _populate_Charts_target_properties(DEBUG "Qt5Chartsd.dll" "Qt5Chartsd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5Charts_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_Charts_check_file_exists(${imported_location})
