...
macro(_populate_3DQuickAnimation_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt53DQuickAnimation_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt53DQuickAnimation_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::3DQuickAnimation)
    ...
    if (EXISTS
        "${_qt53DQuickAnimation_install_prefix}/debug/bin/Qt53DQuickAnimationd.dll"
      AND EXISTS
        "${_qt53DQuickAnimation_install_prefix}/debug/lib/Qt53DQuickAnimationd.lib" )
        _populate_3DQuickAnimation_target_properties(DEBUG "Qt53DQuickAnimationd.dll" "Qt53DQuickAnimationd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt53DQuickAnimation_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_3DQuickAnimation_check_file_exists(${imported_location})
