...
macro(_populate_3DInput_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt53DInput_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt53DInput_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::3DInput)
    ...
    if (EXISTS
        "${_qt53DInput_install_prefix}/debug/bin/Qt53DInputd.dll"
      AND EXISTS
        "${_qt53DInput_install_prefix}/debug/lib/Qt53DInputd.lib" )
        _populate_3DInput_target_properties(DEBUG "Qt53DInputd.dll" "Qt53DInputd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt53DInput_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_3DInput_check_file_exists(${imported_location})
