...
set(Qt5WinExtras_VERSION_STRING 5.12.5)
...
macro(_populate_WinExtras_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5WinExtras_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5WinExtras_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::WinExtras)
    ...
    set(Qt5WinExtras_PRIVATE_INCLUDE_DIRS
        "${_qt5WinExtras_install_prefix}/include/QtWinExtras/5.12.5"
        "${_qt5WinExtras_install_prefix}/include/QtWinExtras/5.12.5/QtWinExtras"
    )
    ...
    foreach(_module_dep ${_Qt5WinExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.5 ${_Qt5WinExtras_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt5WinExtras_install_prefix}/debug/bin/Qt5WinExtrasd.dll"
      AND EXISTS
        "${_qt5WinExtras_install_prefix}/debug/lib/Qt5WinExtrasd.lib" )
        _populate_WinExtras_target_properties(DEBUG "Qt5WinExtrasd.dll" "Qt5WinExtrasd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5WinExtras_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_WinExtras_check_file_exists(${imported_location})
