...
macro(_populate_Test_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Test_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Test_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Test)
    ...
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/QtTest/5.12.5"
        "${_qt5Test_install_prefix}/include/QtTest/5.12.5/QtTest"
    )
    ...
    if (EXISTS
        "${_qt5Test_install_prefix}/debug/bin/Qt5Testd.dll"
      AND EXISTS
        "${_qt5Test_install_prefix}/debug/lib/Qt5Testd.lib" )
        _populate_Test_target_properties(DEBUG "Qt5Testd.dll" "Qt5Testd.lib" )
    endif()
