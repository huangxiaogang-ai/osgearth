...
macro(_populate_3DQuickRender_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt53DQuickRender_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt53DQuickRender_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::3DQuickRender)
    ...
    if (EXISTS
        "${_qt53DQuickRender_install_prefix}/debug/bin/Qt53DQuickRenderd.dll"
      AND EXISTS
        "${_qt53DQuickRender_install_prefix}/debug/lib/Qt53DQuickRenderd.lib" )
        _populate_3DQuickRender_target_properties(DEBUG "Qt53DQuickRenderd.dll" "Qt53DQuickRenderd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt53DQuickRender_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_3DQuickRender_check_file_exists(${imported_location})
