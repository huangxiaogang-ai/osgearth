...
macro(_populate_QuickWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5QuickWidgets_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5QuickWidgets_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    set(Qt5QuickWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickWidgets_install_prefix}/include/QtQuickWidgets/5.12.5"
        "${_qt5QuickWidgets_install_prefix}/include/QtQuickWidgets/5.12.5/QtQuickWidgets"
    )
    ...
    if (EXISTS
        "${_qt5QuickWidgets_install_prefix}/debug/bin/Qt5QuickWidgetsd.dll"
      AND EXISTS
        "${_qt5QuickWidgets_install_prefix}/debug/lib/Qt5QuickWidgetsd.lib" )
        _populate_QuickWidgets_target_properties(DEBUG "Qt5QuickWidgetsd.dll" "Qt5QuickWidgetsd.lib" )
    endif()
