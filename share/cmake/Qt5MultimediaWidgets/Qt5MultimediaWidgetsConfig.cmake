...
macro(_populate_MultimediaWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5MultimediaWidgets_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5MultimediaWidgets_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    set(Qt5MultimediaWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaWidgets_install_prefix}/include/QtMultimediaWidgets/5.12.5"
        "${_qt5MultimediaWidgets_install_prefix}/include/QtMultimediaWidgets/5.12.5/QtMultimediaWidgets"
    )
    ...
    if (EXISTS
        "${_qt5MultimediaWidgets_install_prefix}/debug/bin/Qt5MultimediaWidgetsd.dll"
      AND EXISTS
        "${_qt5MultimediaWidgets_install_prefix}/debug/lib/Qt5MultimediaWidgetsd.lib" )
        _populate_MultimediaWidgets_target_properties(DEBUG "Qt5MultimediaWidgetsd.dll" "Qt5MultimediaWidgetsd.lib" )
    endif()
