...
macro(_populate_Multimedia_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Multimedia_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Multimedia_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Multimedia)
    ...
    set(Qt5Multimedia_PRIVATE_INCLUDE_DIRS
        "${_qt5Multimedia_install_prefix}/include/QtMultimedia/5.12.5"
        "${_qt5Multimedia_install_prefix}/include/QtMultimedia/5.12.5/QtMultimedia"
    )
    ...
    if (EXISTS
        "${_qt5Multimedia_install_prefix}/debug/bin/Qt5Multimediad.dll"
      AND EXISTS
        "${_qt5Multimedia_install_prefix}/debug/lib/Qt5Multimediad.lib" )
        _populate_Multimedia_target_properties(DEBUG "Qt5Multimediad.dll" "Qt5Multimediad.lib" )
    endif()
