...
set(Qt5AxBase_VERSION_STRING 5.12.5)
...
macro(_populate_AxBase_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5AxBase_install_prefix}/debug/lib/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5AxBase_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::AxBase)
    ...
    set(Qt5AxBase_PRIVATE_INCLUDE_DIRS
        "${_qt5AxBase_install_prefix}/include/ActiveQt/5.12.5"
        "${_qt5AxBase_install_prefix}/include/ActiveQt/5.12.5/ActiveQt"
    )
    ...
    foreach(_module_dep ${_Qt5AxBase_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.5 ${_Qt5AxBase_FIND_VERSION_EXACT}
    ...
    if (EXISTS "${_qt5AxBase_install_prefix}/debug/lib/Qt5AxBased.lib" )
        _populate_AxBase_target_properties(DEBUG "Qt5AxBased.lib" "" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5AxBase_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_AxBase_check_file_exists(${imported_location})
