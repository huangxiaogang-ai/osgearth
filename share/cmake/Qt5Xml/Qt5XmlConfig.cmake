...
macro(_populate_Xml_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Xml_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Xml_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Xml)
    ...
    set(Qt5Xml_PRIVATE_INCLUDE_DIRS
        "${_qt5Xml_install_prefix}/include/QtXml/5.12.5"
        "${_qt5Xml_install_prefix}/include/QtXml/5.12.5/QtXml"
    )
    ...
    if (EXISTS
        "${_qt5Xml_install_prefix}/debug/bin/Qt5Xmld.dll"
      AND EXISTS
        "${_qt5Xml_install_prefix}/debug/lib/Qt5Xmld.lib" )
        _populate_Xml_target_properties(DEBUG "Qt5Xmld.dll" "Qt5Xmld.lib" )
    endif()
