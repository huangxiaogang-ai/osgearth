...
macro(_populate_3DExtras_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt53DExtras_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt53DExtras_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::3DExtras)
    ...
    if (EXISTS
        "${_qt53DExtras_install_prefix}/debug/bin/Qt53DExtrasd.dll"
      AND EXISTS
        "${_qt53DExtras_install_prefix}/debug/lib/Qt53DExtrasd.lib" )
        _populate_3DExtras_target_properties(DEBUG "Qt53DExtrasd.dll" "Qt53DExtrasd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt53DExtras_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_3DExtras_check_file_exists(${imported_location})
