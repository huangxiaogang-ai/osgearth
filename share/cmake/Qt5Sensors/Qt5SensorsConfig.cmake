...
macro(_populate_Sensors_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Sensors_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Sensors_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Sensors)
    ...
    set(Qt5Sensors_PRIVATE_INCLUDE_DIRS
        "${_qt5Sensors_install_prefix}/include/QtSensors/5.12.5"
        "${_qt5Sensors_install_prefix}/include/QtSensors/5.12.5/QtSensors"
    )
    ...
    if (EXISTS
        "${_qt5Sensors_install_prefix}/debug/bin/Qt5Sensorsd.dll"
      AND EXISTS
        "${_qt5Sensors_install_prefix}/debug/lib/Qt5Sensorsd.lib" )
        _populate_Sensors_target_properties(DEBUG "Qt5Sensorsd.dll" "Qt5Sensorsd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5Sensors_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_Sensors_check_file_exists(${imported_location})
