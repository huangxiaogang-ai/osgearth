...
macro(_populate_3DLogic_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt53DLogic_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt53DLogic_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::3DLogic)
    ...
    if (EXISTS
        "${_qt53DLogic_install_prefix}/debug/bin/Qt53DLogicd.dll"
      AND EXISTS
        "${_qt53DLogic_install_prefix}/debug/lib/Qt53DLogicd.lib" )
        _populate_3DLogic_target_properties(DEBUG "Qt53DLogicd.dll" "Qt53DLogicd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt53DLogic_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_3DLogic_check_file_exists(${imported_location})
