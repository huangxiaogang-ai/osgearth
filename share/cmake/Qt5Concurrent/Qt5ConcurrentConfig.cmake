...
macro(_populate_Concurrent_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Concurrent_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Concurrent_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Concurrent)
    ...
    if (EXISTS
        "${_qt5Concurrent_install_prefix}/debug/bin/Qt5Concurrentd.dll"
      AND EXISTS
        "${_qt5Concurrent_install_prefix}/debug/lib/Qt5Concurrentd.lib" )
        _populate_Concurrent_target_properties(DEBUG "Qt5Concurrentd.dll" "Qt5Concurrentd.lib" )
    endif()
