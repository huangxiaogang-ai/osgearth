...
macro(_populate_AxServer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5AxServer_install_prefix}/debug/lib/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5AxServer_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::AxServer)
    ...
    if (EXISTS "${_qt5AxServer_install_prefix}/debug/lib/Qt5AxServerd.lib" )
        _populate_AxServer_target_properties(DEBUG "Qt5AxServerd.lib" "" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5AxServer_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_AxServer_check_file_exists(${imported_location})
