...
macro(_populate_UiTools_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5UiTools_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::UiTools)
    ...
    set(Qt5UiTools_PRIVATE_INCLUDE_DIRS
        "${_qt5UiTools_install_prefix}/include/QtUiTools/5.12.5"
        "${_qt5UiTools_install_prefix}/include/QtUiTools/5.12.5/QtUiTools"
    )
    ...
    if (EXISTS "${_qt5UiTools_install_prefix}/debug/lib/Qt5UiToolsd.lib" )
        _populate_UiTools_target_properties(DEBUG "Qt5UiToolsd.lib" "" )
    endif()
