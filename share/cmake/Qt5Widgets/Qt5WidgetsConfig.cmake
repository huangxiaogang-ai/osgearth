...
macro(_populate_Widgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Widgets_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Widgets_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Widgets)
    ...
    if (EXISTS
        "${_qt5Widgets_install_prefix}/debug/bin/Qt5Widgetsd.dll"
      AND EXISTS
        "${_qt5Widgets_install_prefix}/debug/lib/Qt5Widgetsd.lib" )
        _populate_Widgets_target_properties(DEBUG "Qt5Widgetsd.dll" "Qt5Widgetsd.lib" )
    endif()
