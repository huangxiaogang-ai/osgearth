...
macro(_populate_SerialPort_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5SerialPort_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5SerialPort_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::SerialPort)
    ...
    set(Qt5SerialPort_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialPort_install_prefix}/include/QtSerialPort/5.12.5"
        "${_qt5SerialPort_install_prefix}/include/QtSerialPort/5.12.5/QtSerialPort"
    )
    ...
    if (EXISTS
        "${_qt5SerialPort_install_prefix}/debug/bin/Qt5SerialPortd.dll"
      AND EXISTS
        "${_qt5SerialPort_install_prefix}/debug/lib/Qt5SerialPortd.lib" )
        _populate_SerialPort_target_properties(DEBUG "Qt5SerialPortd.dll" "Qt5SerialPortd.lib" )
    endif()
