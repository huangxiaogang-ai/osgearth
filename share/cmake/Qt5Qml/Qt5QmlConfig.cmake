...
macro(_populate_Qml_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Qml_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Qml_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Qml)
    ...
    set(Qt5Qml_PRIVATE_INCLUDE_DIRS
        "${_qt5Qml_install_prefix}/include/QtQml/5.12.5"
        "${_qt5Qml_install_prefix}/include/QtQml/5.12.5/QtQml"
    )
    ...
    if (EXISTS
        "${_qt5Qml_install_prefix}/debug/bin/Qt5Qmld.dll"
      AND EXISTS
        "${_qt5Qml_install_prefix}/debug/lib/Qt5Qmld.lib" )
        _populate_Qml_target_properties(DEBUG "Qt5Qmld.dll" "Qt5Qmld.lib" )
    endif()
