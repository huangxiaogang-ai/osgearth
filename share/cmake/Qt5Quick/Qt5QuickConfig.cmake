...
macro(_populate_Quick_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Quick_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Quick_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Quick)
    ...
    set(Qt5Quick_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick_install_prefix}/include/QtQuick/5.12.5"
        "${_qt5Quick_install_prefix}/include/QtQuick/5.12.5/QtQuick"
    )
    ...
    if (EXISTS
        "${_qt5Quick_install_prefix}/debug/bin/Qt5Quickd.dll"
      AND EXISTS
        "${_qt5Quick_install_prefix}/debug/lib/Qt5Quickd.lib" )
        _populate_Quick_target_properties(DEBUG "Qt5Quickd.dll" "Qt5Quickd.lib" )
    endif()
