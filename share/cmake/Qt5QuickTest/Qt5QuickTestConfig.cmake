...
macro(_populate_QuickTest_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5QuickTest_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5QuickTest_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::QuickTest)
    ...
    set(Qt5QuickTest_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTest_install_prefix}/include/QtQuickTest/5.12.5"
        "${_qt5QuickTest_install_prefix}/include/QtQuickTest/5.12.5/QtQuickTest"
    )
    ...
    if (EXISTS
        "${_qt5QuickTest_install_prefix}/debug/bin/Qt5QuickTestd.dll"
      AND EXISTS
        "${_qt5QuickTest_install_prefix}/debug/lib/Qt5QuickTestd.lib" )
        _populate_QuickTest_target_properties(DEBUG "Qt5QuickTestd.dll" "Qt5QuickTestd.lib" )
    endif()
