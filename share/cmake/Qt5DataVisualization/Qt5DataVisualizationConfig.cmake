...
macro(_populate_DataVisualization_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5DataVisualization_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5DataVisualization_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::DataVisualization)
    ...
    if (EXISTS
        "${_qt5DataVisualization_install_prefix}/debug/bin/Qt5DataVisualizationd.dll"
      AND EXISTS
        "${_qt5DataVisualization_install_prefix}/debug/lib/Qt5DataVisualizationd.lib" )
        _populate_DataVisualization_target_properties(DEBUG "Qt5DataVisualizationd.dll" "Qt5DataVisualizationd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5DataVisualization_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_DataVisualization_check_file_exists(${imported_location})
