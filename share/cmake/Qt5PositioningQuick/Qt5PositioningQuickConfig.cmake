...
macro(_populate_PositioningQuick_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5PositioningQuick_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5PositioningQuick_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::PositioningQuick)
    ...
    set(Qt5PositioningQuick_PRIVATE_INCLUDE_DIRS
        "${_qt5PositioningQuick_install_prefix}/include/QtPositioningQuick/5.12.5"
        "${_qt5PositioningQuick_install_prefix}/include/QtPositioningQuick/5.12.5/QtPositioningQuick"
    )
    ...
    if (EXISTS
        "${_qt5PositioningQuick_install_prefix}/debug/bin/Qt5PositioningQuickd.dll"
      AND EXISTS
        "${_qt5PositioningQuick_install_prefix}/debug/lib/Qt5PositioningQuickd.lib" )
        _populate_PositioningQuick_target_properties(DEBUG "Qt5PositioningQuickd.dll" "Qt5PositioningQuickd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5PositioningQuick_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_PositioningQuick_check_file_exists(${imported_location})
