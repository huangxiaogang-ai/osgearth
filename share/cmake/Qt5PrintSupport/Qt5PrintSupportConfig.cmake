...
macro(_populate_PrintSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5PrintSupport_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5PrintSupport_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::PrintSupport)
    ...
    set(Qt5PrintSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PrintSupport_install_prefix}/include/QtPrintSupport/5.12.5"
        "${_qt5PrintSupport_install_prefix}/include/QtPrintSupport/5.12.5/QtPrintSupport"
    )
    ...
    if (EXISTS
        "${_qt5PrintSupport_install_prefix}/debug/bin/Qt5PrintSupportd.dll"
      AND EXISTS
        "${_qt5PrintSupport_install_prefix}/debug/lib/Qt5PrintSupportd.lib" )
        _populate_PrintSupport_target_properties(DEBUG "Qt5PrintSupportd.dll" "Qt5PrintSupportd.lib" )
    endif()
