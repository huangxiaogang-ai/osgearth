...
macro(_populate_3DAnimation_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt53DAnimation_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt53DAnimation_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::3DAnimation)
    ...
    if (EXISTS
        "${_qt53DAnimation_install_prefix}/debug/bin/Qt53DAnimationd.dll"
      AND EXISTS
        "${_qt53DAnimation_install_prefix}/debug/lib/Qt53DAnimationd.lib" )
        _populate_3DAnimation_target_properties(DEBUG "Qt53DAnimationd.dll" "Qt53DAnimationd.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt53DAnimation_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_3DAnimation_check_file_exists(${imported_location})
