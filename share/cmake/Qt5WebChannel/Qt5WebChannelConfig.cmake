...
macro(_populate_WebChannel_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5WebChannel_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5WebChannel_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::WebChannel)
    ...
    set(Qt5WebChannel_PRIVATE_INCLUDE_DIRS
        "${_qt5WebChannel_install_prefix}/include/QtWebChannel/5.12.5"
        "${_qt5WebChannel_install_prefix}/include/QtWebChannel/5.12.5/QtWebChannel"
    )
    ...
    if (EXISTS
        "${_qt5WebChannel_install_prefix}/debug/bin/Qt5WebChanneld.dll"
      AND EXISTS
        "${_qt5WebChannel_install_prefix}/debug/lib/Qt5WebChanneld.lib" )
        _populate_WebChannel_target_properties(DEBUG "Qt5WebChanneld.dll" "Qt5WebChanneld.lib" )
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
            ...
            set(imported_location "${_qt5WebChannel_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
    endif()
        _qt5_WebChannel_check_file_exists(${imported_location})
