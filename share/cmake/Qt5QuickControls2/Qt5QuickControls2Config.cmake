...
macro(_populate_QuickControls2_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5QuickControls2_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5QuickControls2_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::QuickControls2)
    ...
    set(Qt5QuickControls2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickControls2_install_prefix}/include/QtQuickControls2/5.12.5"
        "${_qt5QuickControls2_install_prefix}/include/QtQuickControls2/5.12.5/QtQuickControls2"
    )
    ...
    if (EXISTS
        "${_qt5QuickControls2_install_prefix}/debug/bin/Qt5QuickControls2d.dll"
      AND EXISTS
        "${_qt5QuickControls2_install_prefix}/debug/lib/Qt5QuickControls2d.lib" )
        _populate_QuickControls2_target_properties(DEBUG "Qt5QuickControls2d.dll" "Qt5QuickControls2d.lib" )
    endif()
