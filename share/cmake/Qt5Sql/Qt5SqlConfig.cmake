...
macro(_populate_Sql_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Sql_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Sql_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Sql)
    ...
    set(Qt5Sql_PRIVATE_INCLUDE_DIRS
        "${_qt5Sql_install_prefix}/include/QtSql/5.12.5"
        "${_qt5Sql_install_prefix}/include/QtSql/5.12.5/QtSql"
    )
    ...
    if (EXISTS
        "${_qt5Sql_install_prefix}/debug/bin/Qt5Sqld.dll"
      AND EXISTS
        "${_qt5Sql_install_prefix}/debug/lib/Qt5Sqld.lib" )
        _populate_Sql_target_properties(DEBUG "Qt5Sqld.dll" "Qt5Sqld.lib" )
    endif()
