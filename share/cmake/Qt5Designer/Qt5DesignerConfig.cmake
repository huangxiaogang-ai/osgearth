...
macro(_populate_Designer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_location "${_qt5Designer_install_prefix}/debug/bin/${LIB_LOCATION}")
    endif()
    ...
    if (${Configuration} STREQUAL "RELEASE")
        ...
        set(imported_implib "${_qt5Designer_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    endif()
...
if (NOT TARGET Qt5::Designer)
    ...
    set(Qt5Designer_PRIVATE_INCLUDE_DIRS
        "${_qt5Designer_install_prefix}/include/QtDesigner/5.12.5"
        "${_qt5Designer_install_prefix}/include/QtDesigner/5.12.5/QtDesigner"
    )
    ...
    if (EXISTS
        "${_qt5Designer_install_prefix}/debug/bin/Qt5Designerd.dll"
      AND EXISTS
        "${_qt5Designer_install_prefix}/debug/lib/Qt5Designerd.lib" )
        _populate_Designer_target_properties(DEBUG "Qt5Designerd.dll" "Qt5Designerd.lib" )
    endif()
