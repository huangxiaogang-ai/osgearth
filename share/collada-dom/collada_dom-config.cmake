...
set(COLLADA_DOM_ROOT_DIR "${CMAKE_CURRENT_LIST_DIR}/../..")
...
if( COLLADA_DOM_FIND_COMPONENTS )
  foreach( component ${COLLADA_DOM_FIND_COMPONENTS} )
    if( ${component} STREQUAL "1.4.1" OR ${component} STREQUAL "1.4" )
      ...
      set( COLLADA_DOM_INCLUDE_DIRS_SPEC ${COLLADA_DOM_INCLUDE_DIRS_SPEC} "${COLLADA_DOM_ROOT_DIR}/include/collada-dom2.5/1.4")
    ...
    elseif( ${component} STREQUAL "1.5.0" OR ${component} STREQUAL "1.5" )
      ...
      set( COLLADA_DOM_INCLUDE_DIRS_SPEC ${COLLADA_DOM_INCLUDE_DIRS_SPEC} "${COLLADA_DOM_ROOT_DIR}/include/collada-dom2.5/1.5")
...
if( ${COLLADA_DOM_NUMCOMPONENTS} EQUAL 1 )
  set(COLLADA_DOM_INCLUDE_DIRS ${COLLADA_DOM_INCLUDE_DIRS_SPEC} "${COLLADA_DOM_ROOT_DIR}/include/collada-dom2.5")
...
set( COLLADA_DOM_Boost_VERSION "1.72")
