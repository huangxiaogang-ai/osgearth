...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonSeparator::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonSeparator.data,
    qt_meta_data_Qtitan__RibbonSeparator,
    qt_static_metacall,
    nullptr,
    nullptr
} };
