...
#include "../src/ribbon/QtnOfficeFrameHelper_win.h"
...
void Qtitan::OfficeFrameHelperWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OfficeFrameHelperWin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::OfficeFrameHelperWin::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Qtitan__OfficeFrameHelperWin.data,
    qt_meta_data_Qtitan__OfficeFrameHelperWin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Qtitan::OfficeFrameHelperWin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "OfficeFrameHelper"))
        return static_cast< OfficeFrameHelper*>(this);
