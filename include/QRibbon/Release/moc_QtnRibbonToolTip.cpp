...
void Qtitan::RibbonToolTip::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RibbonToolTip *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonToolTip::staticMetaObject = { {
    &QFrame::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonToolTip.data,
    qt_meta_data_Qtitan__RibbonToolTip,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonKeyTip::staticMetaObject = { {
    &QFrame::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonKeyTip.data,
    qt_meta_data_Qtitan__RibbonKeyTip,
    qt_static_metacall,
    nullptr,
    nullptr
} };
