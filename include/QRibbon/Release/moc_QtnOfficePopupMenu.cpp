...
void Qtitan::OfficePopupMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OfficePopupMenu *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::OfficePopupMenu::staticMetaObject = { {
    &QMenu::staticMetaObject,
    qt_meta_stringdata_Qtitan__OfficePopupMenu.data,
    qt_meta_data_Qtitan__OfficePopupMenu,
    qt_static_metacall,
    nullptr,
    nullptr
} };
