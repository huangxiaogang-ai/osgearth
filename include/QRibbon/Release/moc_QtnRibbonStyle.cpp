...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonStyle::staticMetaObject = { {
    &OfficeStyle::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonStyle.data,
    qt_meta_data_Qtitan__RibbonStyle,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonStylePlugin::staticMetaObject = { {
    &QStylePlugin::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonStylePlugin.data,
    qt_meta_data_Qtitan__RibbonStylePlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
