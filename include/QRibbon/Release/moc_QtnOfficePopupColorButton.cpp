...
void Qtitan::PopupColorButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PopupColorButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (PopupColorButton::*)(const QColor & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PopupColorButton::colorChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::PopupColorButton::staticMetaObject = { {
    &QToolButton::staticMetaObject,
    qt_meta_stringdata_Qtitan__PopupColorButton.data,
    qt_meta_data_Qtitan__PopupColorButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
