...
#include "../src/ribbon/QtnRibbonBackstageViewPrivate.h"
...
void Qtitan::RibbonBackstageViewPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RibbonBackstageViewPrivate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonBackstageViewPrivate::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonBackstageViewPrivate.data,
    qt_meta_data_Qtitan__RibbonBackstageViewPrivate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
