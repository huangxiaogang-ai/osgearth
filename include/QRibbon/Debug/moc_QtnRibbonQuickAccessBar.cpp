...
QT_MOC_LITERAL(1, 29, 15), // "customizeAction"
QT_MOC_LITERAL(2, 45, 0), // ""
QT_MOC_LITERAL(3, 46, 8) // "QAction*"

    },
    "Qtitan::RibbonQuickAccessBar\0"
    "customizeAction\0\0QAction*"
};
...
void Qtitan::RibbonQuickAccessBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->customizeAction((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        default: ;
        }
