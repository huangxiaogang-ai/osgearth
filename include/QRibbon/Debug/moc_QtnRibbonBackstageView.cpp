...
void Qtitan::RibbonBackstageSeparator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<RibbonBackstageSeparator *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonBackstageSeparator::staticMetaObject = { {
    &QFrame::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonBackstageSeparator.data,
    qt_meta_data_Qtitan__RibbonBackstageSeparator,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
#ifndef QT_NO_PROPERTIES
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<RibbonBackstageButton *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonBackstageButton::staticMetaObject = { {
    &QToolButton::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonBackstageButton.data,
    qt_meta_data_Qtitan__RibbonBackstageButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonBackstagePage::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonBackstagePage.data,
    qt_meta_data_Qtitan__RibbonBackstagePage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void Qtitan::RibbonBackstageView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RibbonBackstageView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (RibbonBackstageView::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RibbonBackstageView::aboutToShow)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RibbonBackstageView::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RibbonBackstageView::aboutToHide)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonBackstageView::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonBackstageView.data,
    qt_meta_data_Qtitan__RibbonBackstageView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
