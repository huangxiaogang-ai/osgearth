...
void Qtitan::RibbonSliderPane::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RibbonSliderPane *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (RibbonSliderPane::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RibbonSliderPane::valueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RibbonSliderPane::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RibbonSliderPane::sliderMoved)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonSliderPane::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonSliderPane.data,
    qt_meta_data_Qtitan__RibbonSliderPane,
    qt_static_metacall,
    nullptr,
    nullptr
} };
