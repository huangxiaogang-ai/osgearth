...
#include "../src/ribbon/QtnRibbonGalleryPrivate.h"
...
void Qtitan::RibbonGalleryPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RibbonGalleryPrivate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonGalleryPrivate::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonGalleryPrivate.data,
    qt_meta_data_Qtitan__RibbonGalleryPrivate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
