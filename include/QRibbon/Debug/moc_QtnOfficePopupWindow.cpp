...
void Qtitan::OfficePopupWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OfficePopupWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (OfficePopupWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OfficePopupWindow::aboutToShow)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (OfficePopupWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OfficePopupWindow::aboutToHide)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::OfficePopupWindow::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Qtitan__OfficePopupWindow.data,
    qt_meta_data_Qtitan__OfficePopupWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
