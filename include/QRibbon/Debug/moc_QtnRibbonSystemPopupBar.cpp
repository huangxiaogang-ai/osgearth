...
void Qtitan::RibbonSystemButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<RibbonSystemButton *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonSystemButton::staticMetaObject = { {
    &QToolButton::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonSystemButton.data,
    qt_meta_data_Qtitan__RibbonSystemButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonSystemPopupBar::staticMetaObject = { {
    &QMenu::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonSystemPopupBar.data,
    qt_meta_data_Qtitan__RibbonSystemPopupBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonPageSystemPopupListCaption::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonPageSystemPopupListCaption.data,
    qt_meta_data_Qtitan__RibbonPageSystemPopupListCaption,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void Qtitan::RibbonPageSystemRecentFileList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RibbonPageSystemRecentFileList *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (RibbonPageSystemRecentFileList::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RibbonPageSystemRecentFileList::openRecentFile)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonPageSystemRecentFileList::staticMetaObject = { {
    &RibbonPageSystemPopupListCaption::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonPageSystemRecentFileList.data,
    qt_meta_data_Qtitan__RibbonPageSystemRecentFileList,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject Qtitan::RibbonPageSystemPopup::staticMetaObject = { {
    &QMenu::staticMetaObject,
    qt_meta_stringdata_Qtitan__RibbonPageSystemPopup.data,
    qt_meta_data_Qtitan__RibbonPageSystemPopup,
    qt_static_metacall,
    nullptr,
    nullptr
} };
